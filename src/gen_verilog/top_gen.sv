...
// For $addr.
logic [31:0] L0_addr_a0;

// For $addr_dmem.
logic [4:0] L0_addr_dmem_a0;
...
// For $rd_en_dmem.
logic L0_rd_en_dmem_a0;

// For $rd_valid.
logic L0_rd_valid_a0;

// For $read_data.
logic [31:0] L0_read_data_a0;

// For $reset.
logic L0_reset_a0;

// For $result.
logic [32:0] L0_result_a0;
...
// For $wr_data_dmem.
logic [31:0] L0_wr_data_dmem_a0;

// For $wr_en_dmem.
logic L0_wr_en_dmem_a0;
...
//
   ...
   if (1) begin : DEBUG_SIGS
      ...
      logic [31:0] \@0$addr ;
      assign \@0$addr = L0_addr_a0;
      logic [4:0] \@0$addr_dmem ;
      assign \@0$addr_dmem = L0_addr_dmem_a0;
      ...
      logic  \@0$rd_en_dmem ;
      assign \@0$rd_en_dmem = L0_rd_en_dmem_a0;
      logic  \@0$rd_valid ;
      assign \@0$rd_valid = L0_rd_valid_a0;
      logic [31:0] \@0$read_data ;
      assign \@0$read_data = L0_read_data_a0;
      logic  \@0$reset ;
      ...
      logic [31:0] \@0$wr_data_dmem ;
      assign \@0$wr_data_dmem = L0_wr_data_dmem_a0;
      logic  \@0$wr_en_dmem ;
      assign \@0$wr_en_dmem = L0_wr_en_dmem_a0;
